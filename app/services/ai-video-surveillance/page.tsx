        ...
        <div className="relative max-w-6xl mx-auto text-center">
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link
                href="/contact"
                className="border border-gray-600 hover:border-gray-500 text-white px-8 py-4 rounded-xl font-semibold transition-colors"
              >
                Get Free Trial
              </Link>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {pricingPlans.map((plan, index) => (
              ...
              >
                ...
                <Link
                  href="/contact"
                  className={`block w-full py-3 rounded-xl font-semibold transition-colors text-center ${plan.popular ? "bg-blue-600 hover:bg-blue-700 text-white" : "border border-gray-600 hover:border-gray-500 text-white"}`}
                >
