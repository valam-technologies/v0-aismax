  ...
  const navigation = [
    { name: "Home", path: "/" },
    {
      ...
      dropdown: [
        ...
        { name: "Engineer System Integrator", path: "/services/engineer-system-integrator" },
  ...
  return (
    ...
    >
        ...
        <div className="flex items-center justify-between h-16 md:h-20">
          <Link href="/" className="flex items-center space-x-3 group">
            <div className="relative">
              <Shield className="w-8 h-8 md:w-10 md:h-10 text-white group-hover:text-gray-300 transition-colors duration-300" />
            ...
            <div className="flex flex-col">
              <span className="text-lg md:text-xl font-bold text-white group-hover:text-gray-200 transition-colors duration-300">
          ...
          <button
            ...
            className="lg:hidden p-2 rounded-lg text-gray-300 hover:bg-gray-900/70 hover:text-white transition-all duration-300"
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            className="lg:hidden fixed inset-x-0 top-16 md:top-20 bg-gray-900/98 backdrop-blur-md border-t border-gray-700 shadow-2xl max-h-[calc(100vh-4rem)] overflow-y-auto"
