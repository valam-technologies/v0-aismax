          ...
          <div className="lg:col-span-2">
            ...
            <div className="mb-8">
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <a href="tel:+17786689399" className="text-gray-300 hover:text-white transition-colors duration-300">
                    +1 (778) 668-9399
                  </a>
                </div>
            ...
            <div className="mb-8">
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center space-x-3">
                  <Phone className="w-5 h-5 text-gray-400" />
                  <a href="tel:+60386793990" className="text-gray-300 hover:text-white transition-colors duration-300">
                    +60-38679 3990
                  </a>
                </div>
                <div className="flex items-start space-x-3">
